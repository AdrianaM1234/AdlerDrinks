...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='NARaspadinhadeAbacaxi.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO drinkscom (rabacaxi) VALUES ('$texto')");
...
?>      
      <body style="background-image:url(imagens/pagNARaspadinhadeAbacaxi.jpg);">
  ...
  <div class="row">
      <div class="col-sm-6 ">
        <div class="well well-sm">
          <form class="form-horizontal" action="queenvi.php" method="post">
          <fieldset>
