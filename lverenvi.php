...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='ACFLagoaVermelha.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO drinkscom (lvermelha) VALUES ('$texto')");
...
?>      
      <body style="background-image:url(imagens/pagACFLagoaVermelha.jpg);">
