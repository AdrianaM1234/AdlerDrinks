...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='ASFCervejaVerde.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO drinkscom (cverde) VALUES ('$texto')");
...
?>      
      <body style="background-image:url(imagens/pagASFCervejaVerde.jpg);">
