...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='ASFBanana.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO drinkscom (banana) VALUES ('$texto')");
...
?>      
      <body style="background-image:url(imagens/pagASFBanana.jpg);">
