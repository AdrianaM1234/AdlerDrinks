...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='NACandy.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO drinkscom (candy) VALUES ('$texto')");
...
?>      
      <body style="background-image:url(imagens/pagNACandy.jpg);">
