...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='ASFAlien.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO drinkscom (alien) VALUES ('$texto')");
...
?>      
      <body style="background-image:url(imagens/pagASFAlien.jpg);">
