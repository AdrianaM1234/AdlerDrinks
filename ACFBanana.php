...
<html>
    ...
    <script src="../js/validator.js"></script>
      ...
      <body style="background-image:url(imagens/pagACFBanana.jpg);">
  ...
  <div class="row">
      <div class="col-sm-6 ">
        <div class="well well-sm">
          <form class="form-horizontal" action="banenvi.php" method="post">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12 text-right" >
                <a href="#"><input  style="margin-right: 300px" type="submit" class="btn btn-success btn-sm" value=" Add Drink aos Favoritos"/></a>
      ...
      <form class="stars">
            Avalie essa receita:
        <div >
            <a name="1" href="b1.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="2" href="b2.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="3" href="b3.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="4" href="b4.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="5" href="b5.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
