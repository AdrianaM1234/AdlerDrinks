...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='vinhoquente.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO bebcascom (vinhoquente) VALUES ('$texto')");
...
?>  
      ...
      <body style="background-image:url(imagens/pagvinho.jpg);">
  ...
  <div class="row">
      <div class="col-sm-6 ">
        <div class="well well-sm">
          <form class="form-horizontal" action="vinenvi.php" method="post">
          <fieldset>
      ...
      <form class="stars">
            Avalie essa receita:
        <div >
            <a name="1" href="vin1.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="2" href="vin2.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="3" href="vin3.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="4" href="vin4.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="5" href="vin5.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
        </div>         
      </form>
    </fieldset>
  </form>
