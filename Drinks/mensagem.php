  ...
  <div class="row">
      <div class="col-sm-6 ">
        <div class="well well-sm">
          <form class="form-horizontal" action="enviando.php" method="post">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea class="form-control" id="message" name="mensagem" placeholder="Please enter your message here..." rows="5"></textarea>
              </div>
            </div>
