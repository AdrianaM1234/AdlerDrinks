...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='quentao.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO bebcascom (quentao) VALUES ('$texto')");
...
<body style="background-image:url(imagens/pagquentao.jpg);">
