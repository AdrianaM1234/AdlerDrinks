...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='ice.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO bebcascom (ice) VALUES ('$texto')");
...
?>  
      ...
      <body style="background-image:url(imagens/pagice.jpg);">
  ...
  <div class="row">
      <div class="col-sm-6 ">
        <div class="well well-sm">
          <form class="form-horizontal" action="iceenvi.php" method="post">
          <fieldset>
      ...
      <form class="stars">
            Avalie essa receita:
        <div >
            <a name="1" href="ice1.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="2" href="ice2.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="3" href="ice3.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="4" href="ice4.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <a name="5" href="ice5.php"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
        </div>         
      </form>
    </fieldset>
  </form>
