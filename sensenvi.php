...
<script type="text/javascript">
    function msgsuccessfully(){
      setTimeout("window.location='NASansations.php'", 1000);
    }
</script>
</head>
...
$sql = mysql_query("INSERT INTO drinkscom (sansations) VALUES ('$texto')");
...
?>      
      <body style="background-image:url(imagens/pagNASansations.jpg);">
